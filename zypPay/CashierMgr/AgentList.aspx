<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentList.aspx.cs" Inherits="CashierMgr.AgentList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function update(id) {
            //EditMerchant.aspx
            $('#updateIframe')[0].src = "EditAgent.aspx?id=" + id;
...
<body>
 ...
 <div align="left" style="margin: 10px">
    ...
    <td><asp:TextBox ID="txtName" runat="server"  ></asp:TextBox></td>
                   <td> 代理编号：</td>
    <td><asp:TextBox ID="txtID" runat="server" class="required"></asp:TextBox></td>
                   <td> 代理类型：</td>
    <td>  <asp:DropDownList ID="ddlAgentType" runat="server">
        </asp:DropDownList>
        </td>
                 <td><asp:Button
...
<input type="button" id="btnNew" onclick ="newClient();" value="新增" runat="server" class="btnoperator"/>
    ...
    <div align="center" id="workspace" style="width: 90%;">
        ...
        <Columns>
        <asp:BoundField HeaderText="代理编号" DataField="AgentID" />
           <asp:BoundField HeaderText="代理名称" DataField="AgentName" />
           
            <asp:BoundField HeaderText="联系人" DataField="Contact" />
               <asp:BoundField HeaderText="代理类型" DataField="AgentType" />
                <asp:BoundField HeaderText="地址" DataField="Address" />

                 <asp:TemplateField HeaderText="操作">
                                <ItemTemplate>
                               <asp:LinkButton ID="LinkButton1" CommandArgument='<%# Bind("AgentID") %>'  
                               CommandName ="cmdUpdate"  runat="server">
                               <img src='images/edit.png' border='0'></asp:LinkButton>
                                   
                                   
                                     <asp:LinkButton ID="LinkButton2" CommandArgument='<%# Bind("AgentID") %>' 
                                     OnClientClick="return confirm('请确认是否要删除该代理');"
        ...
        <webdiyer:aspnetpager id="AspNetPager1" runat="server" firstpagetext="首页" lastpagetext="尾页"
         ...
         <div id="newDiv" class="easyui-window" resizable="false" closed="true" modal="true" title="新增"
                ...
                <iframe scrolling="no" id='newIframe' frameborder="0" src="NewAgent.aspx"
