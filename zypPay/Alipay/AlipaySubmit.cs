...
namespace Alipay
{
    ...
    public class Submit
    {
        ...
        public static string BuildRequest(SortedDictionary<string, string> sParaTemp)
        {
            ...
            try
            {
                ...
                if (proxy != null) myReq.Proxy = proxy;
                //填充POST数据
    ...
    public class AlipaySubmit
    {
        ...
        public AlipaySubmit(string key,string charset,string signtype)
        {
            //AlipayConfig
            _key = key;
            _input_charset = charset.ToLower();
            _sign_type = signtype.ToUpper();// Config.Sign_type.Trim().ToUpper();
        }
